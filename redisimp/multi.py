...
def run(src_queue, channel, shutdown, dst, pattern=None, backfill=False):
    """
...
def _create_worker(src_queue, channel, shutdown, dst, pattern=None,
                   backfill=False):
...
def multi_copy(srclist, dst, worker_count=None, pattern=None, backfill=False):
    """
